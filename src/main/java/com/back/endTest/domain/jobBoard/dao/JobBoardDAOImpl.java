...
public class JobBoardDAOImpl implements JobBoardDAO{
  ...
  @Override
  public void save(JobBoardImage jobBoardImage) {
    String sql = "INSERT INTO JOB_BOARD_IMAGES (FILE_NAME, FILE_PATH, JOB_BOARD_ID) VALUES (?, ?, ?)";
    jdbcTemplate.update(sql, jobBoardImage.getFileName(), jobBoardImage.getFilePath(), jobBoardImage.getJobBoardId());
  }
}
